...
const url = 'produccion/programaEntregaAjustada';

export default class ProgramaEntregaAjustada extends BaseModel {

    no_intervalo
    entrega_acumulado
    demanda_ajustada_intervalo
    demanda_ajustada_acumulada
    procesos
    ...
    set_attributes(attributes = null) {
     ...
     setAtributosDemanda(no_intervalo,demanda_intervalo){
        ...
        this.demanda_ajustada_intervalo = parseInt(demanda_intervalo);
    };

    calcularDemandaAcumulada(demandaAcumuladaAnterior){
      var temp = this.demanda_ajustada_intervalo + parseInt(demandaAcumuladaAnterior);
      this.demanda_ajustada_acumulada = temp;
    };
