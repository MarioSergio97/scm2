...
const url = 'produccion/programaLanzamiento';

export default class ProgramaLanzamiento extends BaseModel {

    no_intervalo
    lanzamiento_acumulado
    demanda_intervalo
    demanda_acumulada
    procesos
    ...
    setLanzamientoAcumulado(lista){
        this.lanzamiento_acumulado = lista;
    };

    /***Funcion que devuelve el numero de intervalo que se quiere encontrar***/
    buscarNI(leadTime){
