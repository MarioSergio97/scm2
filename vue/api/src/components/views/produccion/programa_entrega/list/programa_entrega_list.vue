      ...
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold my-1 mr-5"> Programa acumulado de entrega de cada proceso</h5>
            <!-- end::Page Title -->
            <!--begin::Breadcrumb-->
            <!--<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">-->
              ...
              <!--</li>-->
              <!--<li class="breadcrumb-item">-->
                <!--<a href="" class="text-muted">Programa acumulado de entrega de cada proceso</a>-->
              <!--</li>-->
            <!--</ul>-->
          </div>
        </div>
   ...
   <div>
      <div class="card card-custom">
        <div class="card-header py-3">
          <div class="col-md-6">
            <h6 style="text-align: left">Listado del programa acumulado de entrega de cada proceso</h6>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      filter: null,
      listaProcesos:[],
      columns: mb.statics('ProgramaEntrega').columns,
      loading: false,
      text_select: "Select All",
      selectedRowKeys: [],
      pagination: vantdpagination,
      selected_model: mb.instance( 'ProgramaEntrega'),
  ...
  //   },
    ...
    async load_data() {
      try {
        ...
        this.columns = mb.statics('ProgramaEntrega').crearColumnas(this.listaProcesos);
        this.loading = false;
      } catch (error) {
        utils.process_error(error);
        this.loading = false;
...
<style>
@import "programa_entrega_list.css";
</style>
