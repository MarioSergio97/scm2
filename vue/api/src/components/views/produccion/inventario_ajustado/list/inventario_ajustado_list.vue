      ...
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold my-1 mr-5">Inventario ajustado</h5>
            <!--end::Page Title-->
            <!--begin::Breadcrumb-->
            ...
            <!--</li>-->
            <!--<li class="breadcrumb-item">-->
            <!--<a href="" class="text-muted">Inventario ajustado</a>-->
            <!--</li>-->
            <!--</ul>-->
          </div>
        </div>
    ...
    <div>
      <div class="card card-custom">
        <div class="card-header py-3">
          <div class="col-md-6">
            <h6 style="text-align: left">Listado del inventario ajustado</h6>
          </div>
          <!--&lt;!&ndash; <div class="col-md-6" style="text-align: end;float: right" > &ndash;&gt;-->
          <!--&lt;!&ndash; <div class="row"> &ndash;&gt;-->
          <!--&lt;!&ndash;<div class="col-md-8" style="text-align: end">&ndash;&gt;-->
          ...
          <!--&lt;!&ndash;<a-dropdown-button style="margin-left: 45%;" >&ndash;&gt;-->
            ...
            <div class="row">
              <div class="col">
                <div class="card m-2 shadow">
                  <h5 class="card-title text-center my-3">Inventarios Ajustados Totales</h5>
...
export default {
  ...
  data() {
    return {
      ...
      control_list: [],
      filter: null,
      columns: mb.statics('InventarioAjustado').columns,
      loading: false,
      text_select: "Select All",
      // selectedRowKeys: [],
      pagination: vantdpagination,
      selected_model: mb.instance('InventarioAjustado'),
  ...
  methods: {
    ...
    async load_data() {
      try {
        ...
        /****Aqui cargo el Inventario Ajustado****/
        ...
        this.columns = mb.statics('InventarioAjustado').crearColumnas(this.listaProcesos);
        this.loading = false;
      } catch (error) {
        utils.process_error(error);
        this.loading = false;
...
<style>
@import "inventario_ajustado_list.css";
</style>
