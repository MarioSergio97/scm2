      ...
      <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
          ...
          <div class="d-flex align-items-baseline flex-wrap mr-5">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold my-1 mr-5">Rol</h5>
            <!--end::Page Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
              ...
              <li class="breadcrumb-item">
                <a href="/" class="text-muted">Seguridad</a>
              </li>
              <li class="breadcrumb-item">
   ...
   <div>
      <div class="card card-custom">
        <div class="card-header py-3">
          <div class="col-md-6">
            <h6 style="text-align: left">Listado de  Rol</h6>
          </div>
      ...
      <a-modal
        @cancel="onCloseModal"
        :title="selected_model.get_id()?'Actualizar rol':'Añadir rol'"
        class="modal-form"
        width="55rem"
      ...
      >
        <rol_form  :modal=true :model="selected_model" />
      </a-modal>

      <a-table
        :columns="columns"
        :rowKey="record => record.id_rol"
        :dataSource="data"
...
export default {
  ...
  data() {
    return {
      ...
      selected_model: mb.instance( 'Rol'),
  ...
  watch: {
    filter: function() {
      this.data = this.rol_list.data.filter(this.filter_data);
    },
  ...
  methods: {
    ...
    onCloseModal(e,reload_data=false) {
      this.selected_model = mb.instance('Rol');
    ...
    async load_data() {
      try {
        ...
        const resp = await mb.statics('Rol').list(params);
        this.rol_list = resp;
        this.data = this.rol_list.data.filter(this.filter_data);
        this.loading = false;
      } catch (error) {
    ...
    onEditing(model) {
      this.selected_model = mb.instance('Rol',model);
      this.showModalForm();
    }
  },
