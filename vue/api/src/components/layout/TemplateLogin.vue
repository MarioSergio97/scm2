      ...
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        ...
        >
          <div class="row flex-grow">
            <div
              class="col-lg-6 col-12 px-5 px-lg-2 d-flex align-items-center justify-content-center"
              @keyup.enter="login_action"
            >
              <div class="auth-form-transparent text-left p-3">
                <div v-resize @resize="onResizes" class="login-title">
                  {{ title_part1
                  }}<span class="login-title-span">{{ title_part2 }}</span>
                </div>
                <h4>Bienvenido</h4>
            ...
            <div class="col-lg-6 login-half-bg d-none d-lg-flex flex-row">
              <p
                ...
                "
              >
                Copyright &copy; 2020 SCM-Software-Versión 1.5 Todos los
                derechos reservados.
              </p>
            </div>
          </div>
...
.navbar
  ...
  .navbar-dropdown
  .dropdown-item,
.navbar.default-layout-navbar .navbar-menu-wrapper .navbar-nav,
...
.sales-status-chart-legend ul li,
.list-wrapper ul li,
