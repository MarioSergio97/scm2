...
class Pais_soapController extends SecureController
{
    ...
    public function behaviors()
    {
        ...
        $array['authenticator']['except'] = ['pais_data'];
        return $array;
    }
    /**
     * {@inheritdoc}
    ...
    /**
     * Simple test which returns a List of pais in order to see how the wsdl pans out
     * @param [] $params
     * @return object[]
     * @soap
     */

    public function pais_list()
    {
        $params=[];
        if (func_get_args())
            $params = func_get_args()[0]['params'];
        return $this->encode_result(Pais::list_model($params));
    }

    /**
     * Simple test which returns a data of pais  with id in order to see how the wsdl pans out
     * @param int $id
     * @return api\modules\nomencladores\models\Pais
     * @soap
     */
    public function pais_view($id)
    {
        $params=[];
        if (func_get_args())
            $params = func_get_args()[0]['params'];
        return $this->encode_result(Pais::view($id, $params));
    }
}
