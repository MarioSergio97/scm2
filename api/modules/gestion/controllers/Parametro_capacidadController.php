...
use api\modules\gestion\services\Parametro_capacidadService;
use yii\helpers\Url;
use yii\filters\Cors;
use api\modules\gestion\models\Parametro_capacidad;
use yii\web\ServerErrorHttpException;

class Parametro_capacidadController extends RestController
{
    /**
     * {@inheritdoc}
     */
    public $service ;
    public $modelClass = 'api\modules\gestion\models\Parametro_capacidad';
   ...
   public function getService()
    {
        if ($this->service == null)
            $this->service = new Parametro_capacidadService();
        return $this->service;
    }
